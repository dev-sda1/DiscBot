...
module.exports={
    ...
    run: async(client,message,args)=>{
        ...
        const server_id = "697207068356116512"; //Centro server id
        ...
        console.log(rbx_name);

        //roblox api shit here.
        let rbx_id = null;
        let f_rbx_name = null;
        let pInfo = null;
        ...
        const altCheckEmbed = new RichEmbed()
            .setColor("GREEN")
        ...
        client.channels.get(logchannel).send(altCheckEmbed);
